l1 = 13.8; % length of first arm
l2 = 14.2; % length of second arm

theta1 = 0:0.0174533:3*pi/4; % all possible theta1 values
theta2 = 0:0.0174533:7*pi/9; % all possible theta2 values
