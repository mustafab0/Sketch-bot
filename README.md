...
4.	The following is the visual representation of the workspace of the robot
 https://github.com/mustafab0/Sketch-bot/blob/master/Images/Picture1.png?raw=true

5.	The following is the task space representation of the Sketch-bot
 https://github.com/mustafab0/Sketch-bot/blob/master/Images/Picture2.png?raw=true
Software 
